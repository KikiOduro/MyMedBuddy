...
class HealthLogNotifier extends StateNotifier<List<HealthLog>> {
  HealthLogNotifier() : super([]) {
    _loadLogsFromPrefs(); // Load saved logs on init
  }

  // Checks if there's a log for today
  ...
  // Adds a new log and saves to SharedPreferences
  ...
  // Loads logs from SharedPreferences at startup
...
// Riverpod provider to access the notifier
