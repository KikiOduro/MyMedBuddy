...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // Loads name, age, condition from SharedPreferences
  ...
  // Loads notification toggle value
  ...
  // Toggles notification setting and saves it
  ...
  // Picks a random health tip from list
  void fetchHealthTip() {
    List<String> tips = [
  ...
  // Shows dialog to edit profile info
  void showEditDialog() {
